...
class SchoolApplication : Application() {
    ...
    private fun createNotificationChannel() {
        ...
        //
        // ⚠️ **بقي بلا حارسٍ عمداً — نُظر فيه 2026-09-06 ورُفض التغيير.** يقع في كلّ
        //    إقلاعٍ باردٍ فعلاً، لكنّ الحارسَ المقترَح كان علامةً في `SharedPreferences`
        //    ⇒ **يستبدل نداءَ IPC بفتحِ ملفٍّ على القرص في أبردِ مسارٍ في التطبيق**،
        //    وكلاهما من نفس رتبة الكلفة. **مقايضةٌ بلا مكسبٍ مُثبَت لا تُشحن**؛
        //    ولو لزم يوماً فمقياسُه `adb shell am start -W` قبل وبعد، لا التقدير.
