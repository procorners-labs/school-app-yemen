...
> `internal`** — لا في `main` وحدها. **والـ٦٦٣ ما زالوا على `vc31`**، فالبنودُ تبقى «معلّقة»
...
آخر تحديث: 2026-09-06 (‏شرطا الترقية **تحقّقا مقيسَين** على جهازٍ حقيقيّ · وسقطتا ترقيةٍ
جديدتان نقضتا فرضَ `releaseNotes` وأثبتتا أن العلّة **في المسار لا في الجسم** · وانهيارُ
تقديرِ كلفةِ العزل: مجانيٌّ في وضع `-Promote`. و`production` ما زال على `vc31`.)
