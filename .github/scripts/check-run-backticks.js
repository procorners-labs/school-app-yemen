...
/* 🔴 **قطبٌ رابع: صفرُ ملفّاتٍ مفحوصةٍ يخرج بـ`2` لا `0`.** بغيره تكون «صفرُ مطابقة»
 * **بالمصادفة لا بالإنجاز**: مجلدٌ أُعيدت تسميتُه أو مسارٌ مرَّرَ خطأً ⇒ الحارسُ
 * **يُعلن السلامةَ صادقَ الشكل وسجلُّه أخضرُ نظيف**، وهو الفشلُ الصامتُ بعينه.
 * ⇒ تفعيلُ قاعدةِ «صفرُ مِجَسٍّ لم يُقَس ليس شهادةَ سلامة» **داخل الحارس** بدل
 * الاتّكال على يقظة قارئه. (أُضيف هنا 2026-09-09 بتنبيهٍ من جلسةٍ نظيرة؛
 * والتنفيذُ المرجعيُّ في `SchoolApp` كان يفتقده.) */
if (files.length === 0) {
  console.error('❌ صفرُ ملفّاتِ وركفلو في: ' + dir);
  console.error('   ولا يُقرأ ذلك «نظيفاً» — حارسٌ فقد مدخلاتِه يُعلن السلامةَ زوراً.');
  process.exit(2);
}
